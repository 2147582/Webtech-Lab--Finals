                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                                                ...
                                                                $calc = $perpage * $page;
                                                                $start = $calc - $perpage;
                                                                $sql = "SELECT transaction_id, date_rented,date_returned,status,equipment_name,equipment_price FROM transaction join equipment on transaction.equipment_id=equipment.equipment_id where status = 'denied'";
